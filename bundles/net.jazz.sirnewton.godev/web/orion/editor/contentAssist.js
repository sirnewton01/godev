...
define("orion/editor/contentAssist", [ //$NON-NLS-0$
	...
	// BEGIN GODEV EDIT - Add editor parameter to allow title location to be retrieved for completion service	
	function ContentAssist(textView, editor) {
		if (!editor) {
			debugger;
		}
	// END GODEV EDIT
	...
	ContentAssist.prototype = /** @lends orion.editor.ContentAssist.prototype */ {
		...
		_computeProposals: function(offset) {
			...
			// BEGIN GODEV EDIT - set th title in the context for the content assist
			if (this.editor) {
				params.title = this.editor.getTitle();
			}
			// END GODEV EDIT
	...
	function ContentAssistWidget(contentAssist, parentNode) {
		...
		// BEGIN Patch for bugzilla 426672
