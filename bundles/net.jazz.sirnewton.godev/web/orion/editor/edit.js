		...
		if (!options.readonly) {
			contentAssistFactory = {
				createContentAssistMode: function(editor) {
					// BEGIN GODEV EDIT - Provide editor object to content assist to allow file locations to be provided to completion service
					contentAssist = new mContentAssist.ContentAssist(editor.getTextView(), editor);
					// END GODEV EDIT
