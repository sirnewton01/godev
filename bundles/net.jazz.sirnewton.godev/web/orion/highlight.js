...
/*global define*/
define(['examples/editor/textStyler', 'orion/editor/textMateStyler', 'orion/editor/AsyncStyler', 'godev/goTextStyler', 'orion/Deferred'], 
		function(mTextStyler, mTextMateStyler, AsyncStyler, mGoTextStyler, Deferred) {
	/**
